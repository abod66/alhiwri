                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              productCart[index].productRegPrice+" BD",
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                               ...
                               productCart[index].productPrice+" BD"
                            ,
                            style: TextStyle(
                        ...
                        children: [
                          ...
                          coupons.couponUsed == null
                              ...
                              : Visibility(
                                  ...
                                  child: Text(
                                    "${AppLocalizations.of(context)
                                        .translate('discount')} : ${double.parse(coupons.couponUsed.amount)}",
                                    style:
