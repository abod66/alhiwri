  ...
  Widget build(BuildContext context) {
    ...
    Widget buildOrder = ListenableProvider.value(
      ...
      child: Consumer<OrderProvider>(builder: (context, value, child) {
        ...
        double discount= double.parse(order.detailOrder.total)- double.parse(order.detailOrder.discountTotal);
        double ship=double.parse(order.detailOrder.total)-double.parse(order.detailOrder.shippingTotal);
        return Column(
          children: [
            Expanded(
              child: ListView(
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                                ...
                                style: TextStyle(fontSize: responsiveFont(10))),
                            Text(
                                order.detailOrder.shippingTotal+" BD"
                                    ,
                                style: TextStyle(fontSize: responsiveFont(10))),
                          ],
                        ),
                        Visibility(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                  "-${double.parse(order.detailOrder.discountTotal)} BD",
                                  style: TextStyle(
                                      fontSize: responsiveFont(10),
                                      color: primaryColor)),
                            ],
