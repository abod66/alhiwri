      ...
      child: ListenableProvider.value(
        ...
        child: Consumer<CouponProvider>(builder: (context, value, child) {
          if (value.couponUsed != null) {
            return Container(
              child: Text(
                '${AppLocalizations.of(context).translate('you_get')} ${double.parse(value.couponUsed.amount)} BD ${AppLocalizations.of(context).translate('discount_after')}',
              ...
              child: Card(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      child: Text(
                        '${AppLocalizations.of(context).translate('you_will_get')} ${double.parse(couponModel.amount)} ${AppLocalizations.of(context).translate('discount_by')}',
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            padding: EdgeInsets.symmetric(horizontal: 15),
                            child: Text(
                              "${double.parse(couponModel.amount)} BD discount.",
                              style: TextStyle(
                                fontSize: responsiveFont(10),
                              ),
                            ),
